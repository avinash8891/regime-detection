...
from regime_data_fetch.event_calendar_group_a import (
    build_url_text_fetcher,
    build_v2_curated_candidate_events as _build_v2_curated_candidate_events,
)
...
_build_url_text_fetcher = build_url_text_fetcher
