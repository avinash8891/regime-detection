...
def _axis_outputs_from_core(**kwargs: object) -> AxisSeriesResult:
    from regime_detection.axis_series import _build_axis_outputs as build_outputs

    return build_outputs(**kwargs)


def _new_axis_series_result(**kwargs: object) -> AxisSeriesResult:
    from regime_detection.axis_series import AxisSeriesResult

    return AxisSeriesResult(**kwargs)
