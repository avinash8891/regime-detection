...
from regime_detection._staleness_utils import _STALENESS_SENTINEL
...
from regime_detection.hysteresis import apply_asymmetric_hysteresis, apply_per_label_asymmetric_hysteresis
...
# ---------------------------------------------------------------------------
# Aliases for symbols used by the legacy classifier classes below (origin/main
# classes kept for backwards-compat; they reference the pre-refactoring names).
# These bridge from the old monolithic names to the per-axis module symbols.
# ---------------------------------------------------------------------------

# trend_direction
build_trend_direction_raw_outputs = _trend_direction_mod.build_raw_outputs
apply_trend_direction_hysteresis = _trend_direction_mod.apply_hysteresis
TREND_DIRECTION_RISK_RANK = _trend_direction_mod._RISK_RANK  # noqa: SLF001

# trend_character
build_trend_character_raw_outputs = _trend_character_mod.build_raw_outputs
TREND_CHARACTER_RISK_RANK = _trend_character_mod._RISK_RANK  # noqa: SLF001

# volatility_state
build_volatility_raw_outputs = _volatility_state_mod.build_raw_outputs
VOLATILITY_RISK_RANK = _volatility_state_mod._RISK_RANK  # noqa: SLF001

# breadth_state
build_breadth_raw_outputs = _breadth_state_mod.build_raw_outputs
resolve_breadth_v2_raw_outputs = _breadth_state_mod.resolve_v2_raw_outputs
BREADTH_RISK_RANK = _breadth_state_mod._RISK_RANK  # noqa: SLF001
_PIT_BREADTH_LABELS = _breadth_state_mod._PIT_BREADTH_LABELS  # noqa: SLF001
breadth_data_quality_for_asof = _breadth_state_mod._data_quality_for_asof  # noqa: SLF001

# credit_funding
CreditFundingLabel = _credit_funding_mod.CreditFundingLabel
CREDIT_FUNDING_RISK_RANK = _credit_funding_mod.CREDIT_FUNDING_RISK_RANK
CREDIT_SPREAD_SOURCE_CODE = _credit_funding_mod.CREDIT_SPREAD_SOURCE_CODE
CREDIT_SPREAD_PROXY_BIAS_WARNING_CODE = _credit_funding_mod.CREDIT_SPREAD_PROXY_BIAS_WARNING_CODE
build_credit_funding_rule_inputs_by_date = _credit_funding_mod.build_rule_inputs_by_date
evaluate_credit_funding_rules = _credit_funding_mod.evaluate_rules

# network_fragility_rules
NetworkFragilityLabel = _network_fragility_mod.NetworkFragilityLabel
NETWORK_FRAGILITY_RISK_RANK = _network_fragility_mod.NETWORK_FRAGILITY_RISK_RANK
build_rule_inputs_by_date = _network_fragility_mod.build_rule_inputs_by_date
evaluate_rules = _network_fragility_mod.evaluate_rules

# volume_liquidity_rules
VolumeLiquidityLabel = _volume_liquidity_mod.VolumeLiquidityLabel
VolumeLiquidityRuleInputs = _volume_liquidity_mod.VolumeLiquidityRuleInputs
VOLUME_LIQUIDITY_RISK_RANK = _volume_liquidity_mod.VOLUME_LIQUIDITY_RISK_RANK
evaluate_volume_liquidity_rules = _volume_liquidity_mod.evaluate_rules

# monetary_pressure
MonetaryPressureV2Label = _monetary_pressure_mod.MonetaryPressureV2Label
MONETARY_PRESSURE_V2_RISK_RANK = _monetary_pressure_mod.MONETARY_PRESSURE_V2_RISK_RANK
build_monetary_pressure_rule_inputs_for_date = _monetary_pressure_mod.build_rule_inputs_for_date
evaluate_monetary_pressure_rules = _monetary_pressure_mod.evaluate_rules

# inflation_growth
InflationGrowthLabel = _inflation_growth_mod.InflationGrowthLabel
INFLATION_GROWTH_RISK_RANK = _inflation_growth_mod.INFLATION_GROWTH_RISK_RANK
build_inflation_growth_rule_inputs_by_date = _inflation_growth_mod.build_rule_inputs_by_date
evaluate_inflation_growth_rules = _inflation_growth_mod.evaluate_rules
...
class BreadthSeriesClassifier:
    def build(self, context: MarketContext, feature_store: FeatureStore) -> AxisSeriesResult:
        ...
        from regime_detection.models import AxisOutput
